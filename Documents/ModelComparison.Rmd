...
Both models include 10 Georges Bank species: Atlantic herring (*Clupea harengus*), Atlantic cod (*Gadus morhua*), goosefish (*Lophius americanus*), haddock (*Melanogrammus aeglefinus*), spiny dogfish (*Squalus acanthias*), winter flounder (*Pseudopleuronectes americanus*), yellowtail flounder (*Limanda ferruginea*), Atlantic mackerel (*Scomber scombrus*), silver hake (*Merluccius bilinearis*), and winter skate (*Leucoraja ocellata*).

* The spatial area of Georges Bank was defined as...

The original list of species included in each model is:
* MS_SCAA: Age-based, nine species (spiny dogfish, winter skate, goosefish, Atlantic cod, Atlantic mackerel, pollock, white hake, silver hake, Atlantic herring)
* Hydra: Length-based, ten species (spiny dogfish, winter skate, Atlantic herring, Atlantic cod, haddock, yellowtail flounder, winter flounder, Atlantic mackerel, silver hake, goosefish) 
The difference are that MS_SCAA included pollock, and white hake while Hydra included haddock, yellowtail flounder, and winter flounder.
...
Data needed: number of species interactions, number of length categories, total ecosystem biomass, maximum age of each species, 
