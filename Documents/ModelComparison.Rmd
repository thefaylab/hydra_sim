...
* MS_SCAA:
Six input data series are required for each species: total commercial catch in weight, aggregate survey index in number-per-tow, age proportions for both commercial catches and survey indices, average individual weight-at-age, and for the multispecies runs, age-specific predator diet.

Ecosystem data
- total ecosystem biomass
- maximum age of species
- age of recruitment
-- age of full recruitment into fishery
-- age of partial recruitment into fishery
-- age of recruitment into survey
Species interaction data
- number of interactions and predatory prey direction
- food habits?
Catch data
- commercial catch (biomass)
...
- stomach content
-- consumed species (proportion of stomach weight)
